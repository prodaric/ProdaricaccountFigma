...
Cada wireframe en ASCII está en un bloque `[listing]` + `++++` debajo del título de la sección correspondiente. Evitar modales; preferir tabs, fieldsets y tablas según `figma.md`.
